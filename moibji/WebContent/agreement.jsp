...
<body>
	<div class="agree">
		<a href="header.jsp" id="agree_a">
			<div id="mainlogo">모입지</div>
		</a>
	...
	<div class="terms">
		<div class="terms_header">회원약관</div>
		<div class="member_terms"">
			<textarea col="80" wrap="off" rows="10" readonly>
			인터넷 쇼핑몰 『 (주)모입지 사이버 몰』회원 약관


제1조(목적)
이 약관은 오세웅이 운영하는 (주)모입지 사이버 몰(이하 "몰"이라 한다)에서 
...
제2조(정의)
①"몰" 이란 (주)모입지 회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴
...
번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 (주)더에스제이 사이버몰의 초기 서비스화면(전면)
...
본 약관은 2007년04월05일부터 적용됩니다.
			...
			<div class = "terms_agree">
				<label>
					<input type = "radio" name = "ok" class = "terms_radio"> 약관에 동의합니다.
				</label>
				<label>
					<input type = "radio" name = "ok" class = "terms_radio"> 약관에 동의하지 않습니다.
				</label>
			</div>
		</div>
